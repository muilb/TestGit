...
define(function (require) {
  return function DemoChartFactory(Private) {
    var d3 = require('d3');
    ...
    /**
     * Demo chart with Vertical Bar Chart Visualization: renders vertical and/or stacked bars
     *
     * @class DemoChart
     * @constructor
     * @extends Chart
     ...
     */
    _.class(DemoChart).inherits(PointSeriesChart);
    function DemoChart(handler, chartEl, chartData) {
      if (!(this instanceof DemoChart)) {
        return new DemoChart(handler, chartEl, chartData);
      }

      DemoChart.Super.apply(this, arguments);
     ...
     */
    DemoChart.prototype.addBars = function (svg, layers) {
      var self = this;
     ...
     */
    DemoChart.prototype.updateBars = function (bars) {
     ...
     * @returns {D3.UpdateSelection}
     */
    DemoChart.prototype.addStackedBars = function (bars) {
     ...
     * @returns {D3.UpdateSelection}
     */
    DemoChart.prototype.addGroupedBars = function (bars) {
      var xScale = this.handler.xAxis.xScale;
      var yScale = this.handler.yAxis.yScale;
     ...
     */
    DemoChart.prototype.addBarEvents = function (element, svg) {
     ...
     */
    DemoChart.prototype.addLines = function (svg, data) {
      var self = this;
      var xScale = this.handler.xAxis.xScale;
      var yScale = this.handler.yAxis.yScale;
     ...
     */
    DemoChart.prototype.draw = function () {
      var self = this;
      ...
      return function (selection) {
        selection.each(function (data) {
          ...
          // lbmui
          demoLines = self.addLines(svg, data.series);
